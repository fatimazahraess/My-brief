...
int main()
{
    ...
    case 4:
        ...
        printf("affichage les �l�ments du tableau\n\n");
        ...
        case 1:
            ...
            printf("\n\n");
            printf("affichage les �l�ments du tableau en order descroissant\n\n");
            showcl(cl, tableindex);
            break;
        case 2:
            tric(cl, tableindex);
            printf("\n\n");
            printf("affichage les �l�ments du tableau en order croissant\n\n");
            showcl(cl, tableindex);
            break;
        default:
            //code
